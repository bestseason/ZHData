 ...
 * 
 */
package edu.zhdata.android.zhapp.voice.speech.result.xml;

import android.text.TextUtils;
import android.util.Xml;

import edu.zhdata.android.zhapp.voice.speech.result.FinalResult;
import edu.zhdata.android.zhapp.voice.speech.result.ReadSentenceResult;
import edu.zhdata.android.zhapp.voice.speech.result.ReadSyllableResult;
import edu.zhdata.android.zhapp.voice.speech.result.ReadWordResult;
import edu.zhdata.android.zhapp.voice.speech.result.Result;
import edu.zhdata.android.zhapp.voice.speech.result.entity.Phone;
import edu.zhdata.android.zhapp.voice.speech.result.entity.Sentence;
import edu.zhdata.android.zhapp.voice.speech.result.entity.Syll;
import edu.zhdata.android.zhapp.voice.speech.result.entity.Word;
